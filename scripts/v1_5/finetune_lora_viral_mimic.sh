...
deepspeed --include localhost:2,5 --master_port=29503 llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir /jhcnas5/chenzhixuan/checkpoints/VIRAL/outputs/llava-v1.5-7b-instruct-viral-mimic_new \
    --num_train_epochs 5 \
