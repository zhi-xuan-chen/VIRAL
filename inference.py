...
os.environ["XRCLIP_CKPT"] = "/jhcnas5/chenzhixuan/checkpoints/VIRAL/XR_clip.ckpt"
import argparse
import torch
...
def parse_args():
    ...
    parser.add_argument("--model-path", type=str, default="/jhcnas5/chenzhixuan/checkpoints/VIRAL/outputs/llava-v1.5-7b-instruct-llava-xrclip-mimic/checkpoint-3000")
